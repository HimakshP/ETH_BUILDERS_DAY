          ...
          <Card className="glass md:sticky md:top-20 md:h-fit">
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <img
                  src="https://pbs.twimg.com/profile_images/1871958230223470593/XppqZJpX_400x400.jpg"
                  alt="Prakhar Sharma"
                ...
                <p className="text-gray-400 mb-4">
                  Contributing to a greater cause! Building on SVM and EVM at
                  the same time, Shitposter on X and I don't use LinkedIn
                  (that's not a flex, I'm just lazy)
                </p>
